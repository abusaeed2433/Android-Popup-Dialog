...
/**
 * Represents the data for an iOS style dialog.
 * <p>
 * This class extends {@link BaseStandardDialogData} and provides specific data elements
 * for creating an iOS style dialog, such as heading text, description text, text colors for heading
 * and description, as well as text colors and labels for positive and negative buttons.
 *
 * @author <a href="https://github.com/saadahmedscse">Saad Ahmed</a>
 */
public class IOSDialogData extends BaseStandardDialogData {

    /**
     * Constructs a new IOSDialogData object.
     *
     ...
     */
    public IOSDialogData(String heading, String description, Integer headingTextColor, Integer descriptionTextColor, Integer positiveButtonTextColor, Integer negativeButtonTextColor, String positiveButtonText, String negativeButtonText) {
